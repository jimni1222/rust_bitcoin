...
impl Address {
    ...
    fn bech_network(network: Network) -> bitcoin_bech32::constants::Network {
        match network {
            ...
            _ => bitcoin_bech32::constants::Network::Bitcoin,
        }
    }
...
mod tests {
    ...
    fn test_json_serialize() {
        ...
        assert_eq!(
            json.string(),
            Some("tb1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q0sl5k7")
        );
        let into: Address = json.into_deserialize().unwrap();
        assert_eq!(addr.to_string(), into.to_string());
        assert_eq!(
        ...
        assert_eq!(
            json.string(),
            Some("bcrt1q2nfxmhd4n3c8834pj72xagvyr9gl57n5r94fsl")
        );
        let into: Address = json.into_deserialize().unwrap();
        assert_eq!(addr.to_string(), into.to_string());
        assert_eq!(
